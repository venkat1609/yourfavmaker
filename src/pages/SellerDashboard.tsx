  ...
  if (!seller) {
    return (
      <div className="container max-w-lg py-20 text-center animate-fade-in">
        ...
        <Button asChild><Link to="/seller/register">Become a Seller</Link></Button>
      </div>
    );
  }
  ...
  return (
    <div className="container py-12 animate-fade-in">
      ...
      <p className="text-sm text-muted-foreground mb-6">
        Managing products for <strong>{seller.name}</strong> · <Link to={`/seller/${seller.slug}`} className="text-accent underline underline-offset-4">View Storefront</Link>
      </p>
