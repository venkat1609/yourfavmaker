...
export default function Overview() {
  ...
  const cards = [
    ...
    {
      label: 'Revenue',
      value: stats ? `₹${stats.revenue.toLocaleString('en-IN', { minimumFractionDigits: 2 })}` : '—',
      icon: TrendingUp,
  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {cards.map(card => (
          <div key={card.label} className="border rounded-sm p-5 space-y-2 bg-background/80">
